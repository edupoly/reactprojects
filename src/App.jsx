...
function App() {
  return (
    ...
    <div className='row'>
      ...
      <div style={{backgroundColor:"white"}} className='col-md-4 d-md-block d-sm-none'>
        <Cart></Cart>
      </div>
      <div style={{backgroundColor:"white"}} className='col d-md-none d-sm-block sticky-bottom'>
